 ...
 * generated in the webservice.serverdemo package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://serverDemo.webservice/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://serverDemo.webservice/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: webservice.serverdemo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://serverDemo.webservice/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://serverDemo.webservice/", name = "queryWeatherResponse")
